  ...
  return (
    <div className='flex justify-between'>
      ...
      <ul className=" flex justify-center items-center gap-5 font-roboto font-bold text-darkBlue ">
        <li><a className=' duration-200 ease-in hover:text-[#2490F4]' href="#">Home</a></li>
        <li><a className='duration-200 ease-in hover:text-[#2490F4]' href="#">Tifinagh-OCR</a></li>
        <li><a className='duration-200 ease-in hover:text-[#2490F4]' href="#">FAQ</a></li>
        <li><a className='duration-200 ease-in hover:text-[#2490F4]' href="#">Contact</a></li>
