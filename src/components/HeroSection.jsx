...
const HeroSection = ({ scrollToTifinagh }) => {
  return (
    <div className="flex-col  justify-center items-center w-full py-6">
      <div className='flex flex-col justify-center items-center text-center'>
        <h1 className='text-[45px] font-bold text-darkBlue'>Convert Your <br /> <span className='text-_blue'>Tifinagh</span>  Image to Text</h1>
        ...
        <img className='h-[200px] w-[200px] m-auto mt-4' src="src/assets/illustration-hero.svg" alt="" />
